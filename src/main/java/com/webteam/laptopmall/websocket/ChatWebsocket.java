package com.webteam.laptopmall.websocket;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.webteam.laptopmall.dto.ChatMessageDTO;
import com.webteam.laptopmall.dto.UserDTO;
import com.webteam.laptopmall.entity.ChatMessage;
import com.webteam.laptopmall.service.chat.ChatService;
import com.webteam.laptopmall.service.chat.ChatServiceImpl;
...
public class ChatWebsocket {
    ...
    public void onClose(Session curSession) {
        ...
        String msg = String.format("`%s` close chat.", sender);
        sendAndSaveMessage(msg, ChatMessage.EType.NOTIFICATION);
    }
