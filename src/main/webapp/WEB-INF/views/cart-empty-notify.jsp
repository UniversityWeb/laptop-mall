...
<body>
<c:if test="${param.cart == 'empty'}">
  <div id="notify-cart-empty" class="modal">
      ...
      <div class="modal__inner">
        <div class="confirm-container">
          <div class="form-header">
            <div class="title">
              <span onclick="closeModalNotify()">Notify! </span>
          ...
          <form class="form-content">
              <span class="confirm-mess" style="color: green;">CART IS EMPTY!</span>
...
<script>
  notifyModal = document.getElementById("notify-cart-empty")
